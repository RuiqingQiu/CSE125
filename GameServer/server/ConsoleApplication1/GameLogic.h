...
#define GOLD_PER_KILL 20
#define NUM_OF_CONSTRAINTS 1
#define BUILDING_Y_DELTA 0.075
#define CROWN_Y_THRESHOLD 0.75
#define CROWN_X_THRESHOLD 0.3
#define CROWN_Z_THRESHOLD 0.2
#define CROWN_Y_DELTA 0.05
#define CROWN_XZ_DELTA 0.025
#define CROWN_Y_ROT_DELTA 0.01
