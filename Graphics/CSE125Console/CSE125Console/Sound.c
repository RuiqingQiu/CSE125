...
#include <inttypes.h>
#include <stdbool.h>
#include <io.h> // visual studio equivalent of unistd.h
#include <process.h>
...
ALCenum error; // moved up from below
int stoped = 0;
...
// use _inline in C
static _inline ALenum to_al_format(short channels, short samples){
